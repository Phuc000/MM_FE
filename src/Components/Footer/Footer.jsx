          ...
          <div className="footer__social">
            ...
            <ul className="footer__list social__list">
              <li className="footer__item social__item">
                <a href="#" className="social__link" aria-label="Visit our Facebook page">
                  <i className="fa fa-facebook" aria-hidden="true"></i>
                </a>
              </li>
              <li className="footer__item social__item">
                <a href="#" className="social__link" aria-label="Visit our Instagram profile">
                  <i className="fa fa-instagram" aria-hidden="true"></i>
                </a>
              </li>
              <li className="footer__item social__item">
                <a href="#" className="social__link" aria-label="Visit our Twitter account">

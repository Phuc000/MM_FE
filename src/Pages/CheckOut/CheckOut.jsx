    ...
    try {
      ...
      const transactionPromises = Object.entries(itemsByStore).map(async ([storeID, items]) => {
        ...
        if (
          ...
          response.data.new_bill &&
          response.data.new_bill.transactionId
        ) {
          try {
            await axios.post(
    ...
    if (step === 2) {
      ...
      if (params.has("vnp_Amount")) {
        ...
        if (
          ...
          CustomerRequest !== `Customer: ${user.fName} ${user.lName}`
        ) {
          ...
          <div>
            ...
            <div className="cart-items-wrapper">
              <div className="shipping-info-check">
                <InfoForm userData={formData} setUserData={setFormData} />
              ...
              <div className="cart-items">
                ...
                {selectedCustomerPromotion &&
                  selectedCustomerPromotion.length > 0 &&
